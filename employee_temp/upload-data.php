...
$canUploadData = isPermissionEnabled('upload_data', $conn);
        ...
        <div class="upload-container">
            ...
            <div class="upload-section">
                ...
                <?php if (!$canUploadData): ?>
                    <div style="background: rgba(231, 76, 60, 0.2); border: 1px solid #e74c3c; border-radius: 8px; padding: 15px; margin-bottom: 20px; color: #e74c3c;">
                        <i class="fas fa-lock"></i> <strong>Upload permission denied</strong> - Your admin has not granted you permission to upload data.
                    </div>
                <?php endif; ?>

                <div class="upload-zone" id="uploadZone" <?php echo !$canUploadData ? 'style="opacity: 0.5; pointer-events: none; cursor: not-allowed;" title="Permission denied by admin"' : ''; ?>>
                    ...
                    <input type="file" id="fileInput" accept=".xlsx,.xls,.csv" multiple <?php echo !$canUploadData ? 'disabled' : ''; ?> />
                </div>
