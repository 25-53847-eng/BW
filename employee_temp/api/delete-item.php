...
// Check permission for deleting inventory items
if (!isPermissionEnabled('inventory_delete_item', $conn)) {
    http_response_code(403);
    echo json_encode(['success' => false, 'error' => 'Permission denied. Admin has not granted you access to delete inventory items.']);
    exit;
}
