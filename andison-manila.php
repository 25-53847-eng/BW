...
// Build dataset filter if needed
$dataset_filter = "";
if ($active_dataset !== 'all' && $active_dataset !== '') {
    $safe_dataset = $conn->real_escape_string($active_dataset);
    $dataset_filter = " AND (dataset_name = '$safe_dataset' OR dataset_name IS NULL OR dataset_name = '')";
}
