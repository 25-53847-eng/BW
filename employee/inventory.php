...
// Check permissions for inventory actions
$canAddItem = isPermissionEnabled('inventory_add_item', $conn);
$canEditItem = isPermissionEnabled('inventory_edit_item', $conn);
$canDeleteItem = isPermissionEnabled('inventory_delete_item', $conn);
$canCreatePO = isPermissionEnabled('inventory_create_po', $conn);
