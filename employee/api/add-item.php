...
// Include database config and permission helper
require_once '../db_config.php';
require_once 'permission-helper.php';

// Check permission for adding inventory items
if (!isPermissionEnabled('inventory_add_item', $conn)) {
    http_response_code(403);
    echo json_encode(['success' => false, 'error' => 'Permission denied. Admin has not granted you access to add inventory items.']);
    exit();
}
