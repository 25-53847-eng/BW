...
if (!isPermissionEnabled('inventory_create_po', $conn)) {
    http_response_code(403);
    echo json_encode(['success' => false, 'error' => 'Permission denied. Admin has not granted you access to create purchase orders.']);
    exit();
}
...
try {
    ...
    if ($status === 'Received') {
        ...
        // Keep non-received orders in Purchase Order until they are received
